...
public class WindowsAllApp {
    ...
    public static class Process extends ProcessWindowFunction<Tuple2<String, Integer>, String, Tuple, TimeWindow> {
    ...
    public static class Aggregate implements AggregateFunction<Tuple2<String, Integer>, Tuple3<String, Integer, Integer>, Tuple2<String, Integer>> {
